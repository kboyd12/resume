...
\begin{rSection}{Experience}
    \begin{rSubsection}{GRVTY Corp.}{January 2025 - Present}{Geospatial Engineer}{Remote}
        \item Developed a target and custody fusion engine stack processing thousands of observations per second from multiple disparate intelligence sources across classified networks, providing analysts an automated and scalable solution for Air Force 480th ISR Wing, Air Force Combat Command, and Air Force Research Laboratory.
        \item Built distributed tracking system utilizing advanced filtering and data association techniques including particle/Kalman filters, Joint Probabilistic Data Association, and multiple-hypothesis tracking for simultaneous multi-target tracking in near real-time.
        \item Implemented scalable tech stack using Kafka for data ingestion, FastAPI for API services, and Kubernetes for deployment management, ensuring fault tolerance and high availability.
        \item Delivered contextual and spatio-temporal correlations to users through real-time processing capabilities, enhancing intelligence analysis workflows.

    \end{rSubsection}
	%------------------------------------------------
	\begin{rSubsection}{Secured Transportation Services}{October 2024 - January 2025}{Data Scientist}{Buford, GA}
...
\begin{rSection}{Technical Strengths}
	...
	\begin{tabular}{@{} >{\bfseries}l @{\hspace{6ex}} l @{}}
		...
		Cloud / DevOps                & Kubernetes, Docker, Docker Compose \\
